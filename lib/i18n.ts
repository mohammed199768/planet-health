...
export const translations: Record<Lang, Record<string, string>> = {
  ar: {
    ...
    'hero.description':
      'فريق طبي مختص يصل لعندك في منزلك بمواعيد مرنه.اجهزة معقمة ونتائج موثوقة ومضمونة . نتيجتكم على الواتساب  اريحلكم . ويمكن حجز طبيب منزلي لجميع الاعمار والحالات.',
