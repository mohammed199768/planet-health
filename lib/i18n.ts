...
export const translations: Record<Lang, Record<string, string>> = {
  ar: {
    ...
    // Hero
    'hero.badge': 'ريڤيرا كلينك المختبر لعندك',
...
'about.why.title': 'لماذا ريڤيرا كلينك؟',
...
en: {
  ...
  // Hero
  'hero.badge': 'Rivera Clinic — Home Lab Service',
  ...
  'about.why.title': 'Why Rivera Clinic?',
  'about.why.subtitle':
